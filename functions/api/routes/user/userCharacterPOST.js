...
const { characterDB, userDB } = require('../../../db');
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const user = await userDB.setUserCharacter(client, characterId, userId);

        // 성공적으로 users를 가져왔다면, response를 보내줍니다.
        res.status(statusCode.OK).send(util.success(statusCode.OK, responseMessage.COMPLETE_SET_USER_CHARACTER, user));
